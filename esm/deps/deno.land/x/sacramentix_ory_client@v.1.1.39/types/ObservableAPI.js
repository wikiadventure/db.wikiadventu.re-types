...
export class ObservableCourierApi {
    ...
    getCourierMessage(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getCourierMessage(rsp)));
        }));
    }
    /**
    ...
    listCourierMessages(pageSize, pageToken, status, recipient, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listCourierMessages(rsp)));
        }));
    }
}
...
export class ObservableFrontendApi {
    ...
    createBrowserLoginFlow(refresh, aal, returnTo, cookie, loginChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserLoginFlow(rsp)));
        }));
    }
    /**
    ...
    createBrowserLogoutFlow(cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserLogoutFlow(rsp)));
        }));
    }
    /**
    ...
    createBrowserRecoveryFlow(returnTo, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserRecoveryFlow(rsp)));
        }));
    }
    /**
    ...
    createBrowserRegistrationFlow(returnTo, loginChallenge, afterVerificationReturnTo, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserRegistrationFlow(rsp)));
        }));
    }
    /**
    ...
    createBrowserSettingsFlow(returnTo, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserSettingsFlow(rsp)));
        }));
    }
    /**
    ...
    createBrowserVerificationFlow(returnTo, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createBrowserVerificationFlow(rsp)));
        }));
    }
    /**
    ...
    createNativeLoginFlow(refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createNativeLoginFlow(rsp)));
        }));
    }
    /**
    ...
    createNativeRecoveryFlow(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createNativeRecoveryFlow(rsp)));
        }));
    }
    /**
    ...
    createNativeRegistrationFlow(returnSessionTokenExchangeCode, returnTo, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createNativeRegistrationFlow(rsp)));
        }));
    }
    /**
    ...
    createNativeSettingsFlow(xSessionToken, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createNativeSettingsFlow(rsp)));
        }));
    }
    /**
    ...
    createNativeVerificationFlow(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createNativeVerificationFlow(rsp)));
        }));
    }
    /**
    ...
    disableMyOtherSessions(xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.disableMyOtherSessions(rsp)));
        }));
    }
    /**
    ...
    disableMySession(id, xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.disableMySession(rsp)));
        }));
    }
    /**
    ...
    exchangeSessionToken(initCode, returnToCode, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.exchangeSessionToken(rsp)));
        }));
    }
    /**
    ...
    getFlowError(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getFlowError(rsp)));
        }));
    }
    /**
    ...
    getLoginFlow(id, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getLoginFlow(rsp)));
        }));
    }
    /**
    ...
    getRecoveryFlow(id, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getRecoveryFlow(rsp)));
        }));
    }
    /**
    ...
    getRegistrationFlow(id, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getRegistrationFlow(rsp)));
        }));
    }
    /**
    ...
    getSettingsFlow(id, xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getSettingsFlow(rsp)));
        }));
    }
    /**
    ...
    getVerificationFlow(id, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getVerificationFlow(rsp)));
        }));
    }
    /**
    ...
    getWebAuthnJavaScript(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getWebAuthnJavaScript(rsp)));
        }));
    }
    /**
    ...
    listMySessions(perPage, page, xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listMySessions(rsp)));
        }));
    }
    /**
    ...
    performNativeLogout(performNativeLogoutBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.performNativeLogout(rsp)));
        }));
    }
    /**
    ...
    toSession(xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.toSession(rsp)));
        }));
    }
    /**
    ...
    updateLoginFlow(flow, updateLoginFlowBody, xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateLoginFlow(rsp)));
        }));
    }
    /**
    ...
    updateLogoutFlow(token, returnTo, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateLogoutFlow(rsp)));
        }));
    }
    /**
    ...
    updateRecoveryFlow(flow, updateRecoveryFlowBody, token, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateRecoveryFlow(rsp)));
        }));
    }
    /**
    ...
    updateRegistrationFlow(flow, updateRegistrationFlowBody, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateRegistrationFlow(rsp)));
        }));
    }
    /**
    ...
    updateSettingsFlow(flow, updateSettingsFlowBody, xSessionToken, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateSettingsFlow(rsp)));
        }));
    }
    /**
    ...
    updateVerificationFlow(flow, updateVerificationFlowBody, token, cookie, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateVerificationFlow(rsp)));
        }));
    }
}
...
export class ObservableIdentityApi {
    ...
    batchPatchIdentities(patchIdentitiesBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.batchPatchIdentities(rsp)));
        }));
    }
    /**
    ...
    createIdentity(createIdentityBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createIdentity(rsp)));
        }));
    }
    /**
    ...
    createRecoveryCodeForIdentity(createRecoveryCodeForIdentityBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createRecoveryCodeForIdentity(rsp)));
        }));
    }
    /**
    ...
    createRecoveryLinkForIdentity(createRecoveryLinkForIdentityBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createRecoveryLinkForIdentity(rsp)));
        }));
    }
    /**
    ...
    deleteIdentity(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteIdentity(rsp)));
        }));
    }
    /**
    ...
    deleteIdentityCredentials(id, type, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteIdentityCredentials(rsp)));
        }));
    }
    /**
    ...
    deleteIdentitySessions(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteIdentitySessions(rsp)));
        }));
    }
    /**
    ...
    disableSession(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.disableSession(rsp)));
        }));
    }
    /**
    ...
    extendSession(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.extendSession(rsp)));
        }));
    }
    /**
    ...
    getIdentity(id, includeCredential, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getIdentity(rsp)));
        }));
    }
    /**
    ...
    getIdentitySchema(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getIdentitySchema(rsp)));
        }));
    }
    /**
    ...
    getSession(id, expand, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getSession(rsp)));
        }));
    }
    /**
    ...
    listIdentities(perPage, page, credentialsIdentifier, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listIdentities(rsp)));
        }));
    }
    /**
    ...
    listIdentitySchemas(perPage, page, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listIdentitySchemas(rsp)));
        }));
    }
    /**
    ...
    listIdentitySessions(id, perPage, page, active, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listIdentitySessions(rsp)));
        }));
    }
    /**
    ...
    listSessions(pageSize, pageToken, active, expand, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listSessions(rsp)));
        }));
    }
    /**
    ...
    patchIdentity(id, jsonPatch, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.patchIdentity(rsp)));
        }));
    }
    /**
    ...
    updateIdentity(id, updateIdentityBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.updateIdentity(rsp)));
        }));
    }
}
...
export class ObservableJwkApi {
    ...
    createJsonWebKeySet(set, createJsonWebKeySet, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createJsonWebKeySet(rsp)));
        }));
    }
    /**
    ...
    deleteJsonWebKey(set, kid, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteJsonWebKey(rsp)));
        }));
    }
    /**
    ...
    deleteJsonWebKeySet(set, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteJsonWebKeySet(rsp)));
        }));
    }
    /**
    ...
    getJsonWebKey(set, kid, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getJsonWebKey(rsp)));
        }));
    }
    /**
    ...
    getJsonWebKeySet(set, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getJsonWebKeySet(rsp)));
        }));
    }
    /**
    ...
    setJsonWebKey(set, kid, jsonWebKey, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setJsonWebKey(rsp)));
        }));
    }
    /**
     * Use this method if you do not want to let Hydra generate the JWKs for you, but instead save your own.  A JSON Web Key (JWK) is a JavaScript Object Notation (JSON) data structure that represents a cryptographic key. A JWK Set is a JSON data structure that represents a set of JWKs. A JSON Web Key is identified by its set and key id. ORY Hydra uses this functionality to store cryptographic keys used for TLS and JSON Web Tokens (such as OpenID Connect ID tokens), and allows storing user-defined keys as well.
    ...
    setJsonWebKeySet(set, jsonWebKeySet, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setJsonWebKeySet(rsp)));
        }));
    }
}
...
export class ObservableMetadataApi {
    ...
    getVersion(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getVersion(rsp)));
        }));
    }
    /**
    ...
    isAlive(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.isAlive(rsp)));
        }));
    }
    /**
    ...
    isReady(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.isReady(rsp)));
        }));
    }
}
...
export class ObservableOAuth2Api {
    ...
    acceptOAuth2ConsentRequest(consentChallenge, acceptOAuth2ConsentRequest, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.acceptOAuth2ConsentRequest(rsp)));
        }));
    }
    /**
    ...
    acceptOAuth2LoginRequest(loginChallenge, acceptOAuth2LoginRequest, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.acceptOAuth2LoginRequest(rsp)));
        }));
    }
    /**
    ...
    acceptOAuth2LogoutRequest(logoutChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.acceptOAuth2LogoutRequest(rsp)));
        }));
    }
    /**
    ...
    createOAuth2Client(oAuth2Client, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createOAuth2Client(rsp)));
        }));
    }
    /**
    ...
    deleteOAuth2Client(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteOAuth2Client(rsp)));
        }));
    }
    /**
    ...
    deleteOAuth2Token(clientId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteOAuth2Token(rsp)));
        }));
    }
    /**
    ...
    deleteTrustedOAuth2JwtGrantIssuer(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteTrustedOAuth2JwtGrantIssuer(rsp)));
        }));
    }
    /**
    ...
    getOAuth2Client(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOAuth2Client(rsp)));
        }));
    }
    /**
    ...
    getOAuth2ConsentRequest(consentChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOAuth2ConsentRequest(rsp)));
        }));
    }
    /**
    ...
    getOAuth2LoginRequest(loginChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOAuth2LoginRequest(rsp)));
        }));
    }
    /**
    ...
    getOAuth2LogoutRequest(logoutChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOAuth2LogoutRequest(rsp)));
        }));
    }
    /**
    ...
    getTrustedOAuth2JwtGrantIssuer(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getTrustedOAuth2JwtGrantIssuer(rsp)));
        }));
    }
    /**
    ...
    introspectOAuth2Token(token, scope, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.introspectOAuth2Token(rsp)));
        }));
    }
    /**
    ...
    listOAuth2Clients(pageSize, pageToken, clientName, owner, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listOAuth2Clients(rsp)));
        }));
    }
    /**
    ...
    listOAuth2ConsentSessions(subject, pageSize, pageToken, loginSessionId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listOAuth2ConsentSessions(rsp)));
        }));
    }
    /**
    ...
    listTrustedOAuth2JwtGrantIssuers(maxItems, defaultItems, issuer, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listTrustedOAuth2JwtGrantIssuers(rsp)));
        }));
    }
    /**
    ...
    oAuth2Authorize(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.oAuth2Authorize(rsp)));
        }));
    }
    /**
    ...
    oauth2TokenExchange(grantType, clientId, code, redirectUri, refreshToken, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.oauth2TokenExchange(rsp)));
        }));
    }
    /**
    ...
    patchOAuth2Client(id, jsonPatch, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.patchOAuth2Client(rsp)));
        }));
    }
    /**
    ...
    rejectOAuth2ConsentRequest(consentChallenge, rejectOAuth2Request, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.rejectOAuth2ConsentRequest(rsp)));
        }));
    }
    /**
    ...
    rejectOAuth2LoginRequest(loginChallenge, rejectOAuth2Request, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.rejectOAuth2LoginRequest(rsp)));
        }));
    }
    /**
    ...
    rejectOAuth2LogoutRequest(logoutChallenge, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.rejectOAuth2LogoutRequest(rsp)));
        }));
    }
    /**
    ...
    revokeOAuth2ConsentSessions(subject, client, all, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.revokeOAuth2ConsentSessions(rsp)));
        }));
    }
    /**
    ...
    revokeOAuth2LoginSessions(subject, sid, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.revokeOAuth2LoginSessions(rsp)));
        }));
    }
    /**
    ...
    revokeOAuth2Token(token, clientId, clientSecret, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.revokeOAuth2Token(rsp)));
        }));
    }
    /**
    ...
    setOAuth2Client(id, oAuth2Client, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setOAuth2Client(rsp)));
        }));
    }
    /**
    ...
    setOAuth2ClientLifespans(id, oAuth2ClientTokenLifespans, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setOAuth2ClientLifespans(rsp)));
        }));
    }
    /**
    ...
    trustOAuth2JwtGrantIssuer(trustOAuth2JwtGrantIssuer, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.trustOAuth2JwtGrantIssuer(rsp)));
        }));
    }
}
...
export class ObservableOidcApi {
    ...
    createOidcDynamicClient(oAuth2Client, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createOidcDynamicClient(rsp)));
        }));
    }
    /**
    ...
    deleteOidcDynamicClient(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteOidcDynamicClient(rsp)));
        }));
    }
    /**
    ...
    discoverOidcConfiguration(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.discoverOidcConfiguration(rsp)));
        }));
    }
    /**
    ...
    getOidcDynamicClient(id, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOidcDynamicClient(rsp)));
        }));
    }
    /**
    ...
    getOidcUserInfo(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getOidcUserInfo(rsp)));
        }));
    }
    /**
    ...
    revokeOidcSession(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.revokeOidcSession(rsp)));
        }));
    }
    /**
    ...
    setOidcDynamicClient(id, oAuth2Client, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setOidcDynamicClient(rsp)));
        }));
    }
}
...
export class ObservablePermissionApi {
    ...
    checkPermission(namespace, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, maxDepth, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.checkPermission(rsp)));
        }));
    }
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
    ...
    checkPermissionOrError(namespace, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, maxDepth, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.checkPermissionOrError(rsp)));
        }));
    }
    /**
    ...
    expandPermissions(namespace, object, relation, maxDepth, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.expandPermissions(rsp)));
        }));
    }
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
    ...
    postCheckPermission(maxDepth, postCheckPermissionBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.postCheckPermission(rsp)));
        }));
    }
    /**
     * To learn how relationship tuples and the check works, head over to [the documentation](https://www.ory.sh/docs/keto/concepts/api-overview).
    ...
    postCheckPermissionOrError(maxDepth, postCheckPermissionOrErrorBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.postCheckPermissionOrError(rsp)));
        }));
    }
}
...
export class ObservableProjectApi {
    ...
    createProject(createProjectBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createProject(rsp)));
        }));
    }
    /**
    ...
    createProjectApiKey(project, createProjectApiKeyRequest, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createProjectApiKey(rsp)));
        }));
    }
    /**
    ...
    deleteProjectApiKey(project, tokenId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteProjectApiKey(rsp)));
        }));
    }
    /**
    ...
    getActiveProjectInConsole(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getActiveProjectInConsole(rsp)));
        }));
    }
    /**
    ...
    getProject(projectId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getProject(rsp)));
        }));
    }
    /**
    ...
    getProjectMembers(projectId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getProjectMembers(rsp)));
        }));
    }
    /**
    ...
    getProjectMetrics(projectId, eventType, resolution, _from, to, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getProjectMetrics(rsp)));
        }));
    }
    /**
    ...
    listProjectApiKeys(project, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listProjectApiKeys(rsp)));
        }));
    }
    /**
    ...
    listProjects(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listProjects(rsp)));
        }));
    }
    /**
    ...
    patchProject(projectId, jsonPatch, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.patchProject(rsp)));
        }));
    }
    /**
    ...
    purgeProject(projectId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.purgeProject(rsp)));
        }));
    }
    /**
    ...
    removeProjectMember(projectId, memberId, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.removeProjectMember(rsp)));
        }));
    }
    /**
    ...
    setActiveProjectInConsole(setActiveProjectInConsoleBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setActiveProjectInConsole(rsp)));
        }));
    }
    /**
    ...
    setProject(projectId, setProject, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.setProject(rsp)));
        }));
    }
}
...
export class ObservableRelationshipApi {
    ...
    checkOplSyntax(body, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.checkOplSyntax(rsp)));
        }));
    }
    /**
    ...
    createRelationship(createRelationshipBody, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.createRelationship(rsp)));
        }));
    }
    /**
    ...
    deleteRelationships(namespace, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.deleteRelationships(rsp)));
        }));
    }
    /**
    ...
    getRelationships(pageToken, pageSize, namespace, object, relation, subjectId, subjectSetNamespace, subjectSetObject, subjectSetRelation, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.getRelationships(rsp)));
        }));
    }
    /**
     * Get all namespaces
    ...
    listRelationshipNamespaces(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.listRelationshipNamespaces(rsp)));
        }));
    }
    /**
    ...
    patchRelationships(relationshipPatch, _options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.patchRelationships(rsp)));
        }));
    }
}
...
export class ObservableWellknownApi {
    ...
    discoverJsonWebKeys(_options) {
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(map((rsp) => this.responseProcessor.discoverJsonWebKeys(rsp)));
        }));
    }
}
